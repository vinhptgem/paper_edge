...
if __name__ == '__main__':
    ...
    cv2.imwrite(f'{dst_dir}/gs_{os.path.basename(img_path)}.png', tmp_y * 255.)
    ...
    cv2.imwrite(f'{dst_dir}/ls_{os.path.basename(img_path)}', ls_y * 255.)

    print('Processing time: {:.2f}'.format(time.time() - start_t))
